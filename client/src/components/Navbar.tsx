    ...
    <>
      {isDemo && (
        ...
        >
          ...
          >
            Please do not enter personal or sensitive information. You should
            have no expectation of privacy when using this demo site. All data
            is publicly accessible and may be deleted at any time.
          </div>
          <div
            style={{
              fontSize: "0.75rem",
